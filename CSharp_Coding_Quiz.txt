...
1. Print your name ✅
2. Print your age ✅
3. Declare 3 variables: name, age, school and print them ✅
4. Store a decimal and print: "Value is: [value]" ✅
5. Store a character and print: "Grade: [char]" ✅
6. Store true/false and print: "Enrolled: [bool]" ✅
7. Add two numbers and print the result ✅	
8. Multiply two numbers and show: "Product is: [value]" ✅
9. Print: "I love coding in C#!" ✅
...
24. Ask the user for a number, then display its square (number × number).
25. Ask the user for a number, then display its cube (number × number × number).
...
27. Ask the user to enter their age, then check if the input is within a valid range (0–120).
...
30. Ask the user to enter their marks. Display "Fail" if it’s less than 75; otherwise, display "Pass".
...
37. Ask the user to input a score (0–100), then convert it to a letter grade (A–F).
38. Ask the user to enter a single character, then determine if it is a vowel or consonant.
39. Ask the user to input a month number (1–12), then display the corresponding month name.
